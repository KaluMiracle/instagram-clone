...
function DashBoardApp(){
    ...
    const users =[
                {key: 1, username:"miracle", name:"Kalu Miracle", image: miracle, comment: "Good morning y'all, have a nice day"},
                {key: 2, username:"rihanna", name:"Rihanna Fenty", image: rihanna, comment: "music!!!!" },
                {key: 3, username:"chinaza", name:"Kalu Chinaza", image: chinaza, comment: "make some noise"},
                {key: 4, username:"supercars", name:"supercars global", image: supercar, comment:"looking good" },
                {key: 5, username:"kasmir", name:"Kasmir Diamond",  image: kasmir, comment: "goodDay"},
                {key: 6, username:"melody", name:"Kalu Melody", image: melody, comment:"they cant stop my shine"},
                {key: 7, username:"bright", name:"Kalu Bright", image: bright, comment: "ZAZU Zehhhhh"},
